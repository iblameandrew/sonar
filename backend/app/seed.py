...
INITIAL_SUBTASKS = [
    ("Architecture", "Define QSA system architecture and module boundaries", None),
...
def create_project_canvas(user_prompt: str | None = None) -> ProjectCanvas:
    ...
    goal = prompt or "Build Qualitative Self-Attention — qualitative social physics as software"
...
DEFAULT_OUGHT: dict = {
    "description": "QSA must be demo-ready with society outperforming single-agent baseline",
